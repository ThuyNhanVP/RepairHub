    ...
    <div class="min-h-screen flex flex-col">
        <header class="bg-white border-b border-slate-200 px-6 py-4">
            <div class="max-w-2xl mx-auto flex items-center justify-between">
                <h1 class="text-2xl font-semibold text-slate-900">Thêm khách hàng mới</h1>
        ...
        <main class="flex-1 max-w-2xl w-full mx-auto px-6 py-8">
            ...
            <form method="POST" action="{{ route('customers.store') }}" class="bg-white rounded-xl border border-slate-200 p-6 space-y-6">
                @csrf
